      ...
      <div class="d_t">
         <div class="d_c">
           ...
           <div class="container_hero">
             ...
             <h4 class=" wow fadeInDown" data-wow-delay="0.2s"> strategic design agency</h4>
            <h3 class=" wow fadeInDown" data-wow-delay="0.4s">We move brands forward.
Through progress by design.
Specializing in branding and
visual identity.</h3>
            <p class=" wow fadeInDown" data-wow-delay="0.6s">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
